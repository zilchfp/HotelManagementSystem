    ...
    <div class="mdui-list" mdui-collapse="{accordion: true}" style="margin-bottom: 76px;">
        <div class="mdui-collapse-item mdui-collapse-item-close ">
            ...
            <div class="mdui-collapse-item-body mdui-list">
                <a href="RoomTypeSetting.jsp" class="mdui-list-item mdui-ripple ">客房类型设置</a>
        ...
        <div class="mdui-collapse-item mdui-collapse-item-close ">
            ...
            <div class="mdui-collapse-item-body mdui-list">
                <a href="./CustomerSetting.jsp" class="mdui-list-item mdui-ripple ">客户账号管理</a>
                <a href="./ReceptionistSetting.jsp" class="mdui-list-item mdui-ripple ">接待员账号管理</a>
            </div>
        </div>
        ...
        <div class="mdui-collapse-item mdui-collapse-item-close">
            ...
            <div class="mdui-collapse-item-body mdui-list">
                <a href="./RoomPreservation.jsp" class="mdui-list-item mdui-ripple ">控房功能</a>
                <a href="./BookManagement.jsp" class="mdui-list-item mdui-ripple ">预订单管理</a>
                <a href="./GroupBook.jsp" class="mdui-list-item mdui-ripple ">团体预定</a>
        ...
        <div class="mdui-collapse-item mdui-collapse-item-close">
            ...
            <div class="mdui-collapse-item-body mdui-list">
                <a href="./RoomReport.jsp" class="mdui-list-item mdui-ripple ">房态统计</a>
                <a href="./SaleReportOfMonth.jsp" class="mdui-list-item mdui-ripple ">销售月报表</a>
                <a href="./ReportOfLivingCustomer.jsp" class="mdui-list-item mdui-ripple ">在住客人报表</a>
                <a href="./ReportOfLivingGroup.jsp" class="mdui-list-item mdui-ripple ">在住团队报表</a>
            </div>
        </div>
