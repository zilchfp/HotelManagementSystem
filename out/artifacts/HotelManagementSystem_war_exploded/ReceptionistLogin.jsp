            ...
            <div class="mdui-center" style="width: 500px;">
                <table style="justify-content: center;margin-left: auto;margin-right: auto;">
                    <tr><td>
                        ...
                        <td>
                            <div class="mdui-textfield">
                                <input class="mdui-textfield-input" type="text" placeholder="用户名" name="receptionistName"/>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr><td>密&nbsp;&nbsp;码：</td>
                        <td>
                            <div class="mdui-textfield">
                                <input class="mdui-textfield-input"  type="password" placeholder="密码" name="receptionistPassword"/>
                            </div>
                        </td>
                    </tr>
                </table>
