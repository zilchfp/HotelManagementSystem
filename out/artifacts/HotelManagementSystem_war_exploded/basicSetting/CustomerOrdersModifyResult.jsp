...
<div class="mdui-container main-container mdui-text-left">
    ...
    <div class="mdui-table-fluid">
        <table class="mdui-table mdui-table-hoverable">
            ...
            <tr>
                <th>订单ID</th>
                <th><jsp:getProperty name="queryOrder" property="orderID"></jsp:getProperty></th>
            </tr>
            <tr>
                <th>房间ID</th>
                <th><jsp:getProperty name="queryOrder" property="roomID"></jsp:getProperty></th>
            </tr>
            <tr>
                <th>客户ID</th>
                <th><jsp:getProperty name="queryOrder" property="customerID"></jsp:getProperty></th>
            </tr>
            <tr>
                <th>客户姓名</th>
                <th><jsp:getProperty name="queryOrder" property="customerName"></jsp:getProperty></th>
            </tr>
            <tr>
                <th>入住日期</th>
                <th><jsp:getProperty name="queryOrder" property="dateBegin"></jsp:getProperty></th>
            </tr>
            <tr>
                <th>结束日期</th>
                <th><jsp:getProperty name="queryOrder" property="dateEnd"></jsp:getProperty></th>
            </tr>
            <tr>
                <th>房间类型</th>
                <th><jsp:getProperty name="queryOrder" property="type"></jsp:getProperty></th>
            </tr>
            <tr>
                <th>订单状态</th>
                <th><jsp:getProperty name="queryOrder" property="status"></jsp:getProperty></th>
            </tr>
            </tbody>
        </table>
    </div>
